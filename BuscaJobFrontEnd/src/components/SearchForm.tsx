...
export function SearchForm({ onBuscar }: { onBuscar: (c: BuscarCriterios) => void }) {
  ...
  const cargoOptions = ['Analista de Sistemas','Desenvolvedor','Backend','Frontend','QA','DevOps','Product Manager','Gerente de TI','Coordenador de TI']
  const localOptions = ['São Paulo','Belo Horizonte','Rio de Janeiro','Curitiba','Porto Alegre','Santa Catarina','Remoto','Híbrido']
